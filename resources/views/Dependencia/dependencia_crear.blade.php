                            ...
                            <div class="col-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h2 class="card-title">Crear Dependencia</h2>
                                    </div>
                                    <div class="card-body">
                                        <a href="{{ route('dependencia') }}" class="btn btn-primary" role="button">Ir a la lista <i class="bi bi-card-list"></i></a>
                                        <form action="{{ route('dependencia.store') }}" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-outline col-lg-4 col-md-4 ">
                                                    <label class="form-label ">Tipo de dependencia</label>
