      ...
      <div class="row">
        <div class="col-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <blockquote class="blockquote">
                <font align="center"><p>Listado de Documentos por Sector</p></font>
            </blockquote>
            </figure>
        </div>
        <br>
          <a href="{{route('documentos.create')}}" role="button">Añadir <i class="fa-regular fa-square-plus"></i></a>
...
<div class="modal fade" id="ModalVer" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td value="">{{$documentoh->Tipo_documento}}</td>
    <tr>
        @endforeach
</tbody>
</table>
