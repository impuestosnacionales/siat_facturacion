...
<body>
    ...
    <div class="row flex-nowrap">
      ...
      <div class="row">
        <div class="col-12 col-md-12 col-sm-12 col-xs-12">
          <font align="center"><h1>Listado de Productos y Servicios Asignados por su(s) Actividad(es) Economica(s)</h1></font>
          <a href="{{ route('actividad.create') }}" class="btn btn-primary" role="button">Añadir</a>
        </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      <a class="btn btn-success" href="{{route('actividad.show',$actividades->id)}}" role="button">Ver</a>
      <a class="btn btn-info" href="{{route('actividad.edit',$actividades->id)}}" role="button">Editar</a>
      </td>
    </tr>
    @endforeach
  </tbody>
