    ...
    <div class="row flex-nowrap">
        ...
        <div class="row">
            <div class="col col-md-12 col-sm-12 justify-content-center">
                ...
                <form action="{{route('contribuyente.store')}}" method="POST">
                    @csrf
                    <input type="hidden" name="_token" value="{{csrf_token()}}"> 
                    <br>
  <div class="mb-3">
    <label class="form-label">Descripcion Producto Contribuyente</label>
    <input type="text" class="form-control" placeholder="Añade la descripcion" name="Descripcion_Producto_Contribuyente"> 
  </div>
  <div class="mb-3">
    <label class="form-label">Precio</label>
    <input type="number" class="form-control" id="exampleInputPassword1" placeholder="Añade el precio" name="Precio">
  </div>
  <div class="mb-3">
    <label class="form-label">Unidad de Medida</label>
    <input type="text" class="form-control" placeholder="Unidad de Medida" name="Unidad_de_Medida">
  </div>
