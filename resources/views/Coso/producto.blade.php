...
<body>
    ...
    <div class="row flex-nowrap">
      ...
      <div class="row">
        <div class="col-12 col-md-12 col-sm-12 col-xs-12">
          <font align="center"><h1>Lista de Productos</h1></font>
          <a href="{{ route('producto.create') }}" class="btn btn-primary" role="button">Añadir producto</a>
        </div>
  ...
  <tbody>
    ...
    <tr>
      <td>{{$productos->Codigo_Producto_SIN }}</td>
      <td>{{$productos->Codigo_Actividad_CAEB}}</td>
      <td>{{$productos->Descripcion_o_producto_SIN}}</td>
      <td>{{$productos->id_contribuyente}}</td>
      <td>
      <a class="btn btn-success" href="{{route('producto.show',$productos->id)}}" role="button">Ver</a>
      <a class="btn btn-info" href="{{route('producto.edit',$productos->id)}}" role="button">Editar</a>
      </td>
    </tr>
    @endforeach
  </tbody>
