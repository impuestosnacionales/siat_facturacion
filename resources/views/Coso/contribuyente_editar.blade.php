...
<body>
    ...
    <div class="row flex-nowrap">
        ...
        <div class="row">
            <div class="col col-md-12 col-sm-12 justify-content-center">
                ...
                <a href="{{route('contribuyente')}}" class="btn btn-primary" role="button">Lista de Contribuyentes</a>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control"  name="Descripcion_Producto_Contribuyente" value="{{$contribuyente->Descripcion_Producto_Contribuyente}}"> 
  </div>
  <div class="mb-3">
    <label class="form-label">Precio</label>
    <input type="number" class="form-control" id="exampleInputPassword1"  name="Precio" value="{{$contribuyente->Precio}}">
  </div>
  <div class="mb-3">
    <label class="form-label">Unidad de Medida</label>
    <input type="text" class="form-control" placeholder="Unidad de Medida" name="Unidad_de_Medida" value="{{$contribuyente->Unidad_de_Medida}}">
  </div>
