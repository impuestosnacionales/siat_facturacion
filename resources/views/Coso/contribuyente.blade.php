...
<body>
    ...
    <div class="row flex-nowrap">
      ...
      <div class="row">
        <div class="col-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <a href="{{ route('contribuyente.create') }}" class="btn btn-primary" role="button">Añadir Contribuyente</a>
        </div>
  ...
  <thead class="table-primary">
    <tr>
      <br>
      <th>Descripcion Producto Contribuyente</th>
      <th>Precio</th>
  ...
  <tbody>
    @foreach($contribuyente as $contribuyentes)
    <tr>
      <td>{{ $contribuyentes->Descripcion_Producto_Contribuyente }}</td>
      <td>{{$contribuyentes->Precio}}</td>
      <td>{{$contribuyentes->Unidad_de_Medida}}</td>
      <td>
        <a class="btn btn-success" href="{{route('contribuyente.show',$contribuyentes->id)}}" role="button">Ver</a>
        <a class="btn btn-info" href="{{route('contribuyente.edit',$contribuyentes->id)}}" role="button">Editar</a>
      </td>
    </tr>
    @endforeach
  </tbody>
