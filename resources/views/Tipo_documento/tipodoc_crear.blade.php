                            ...
                            <div class="col-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h2 class="card-title">Añadir tipo de documento</h2>
                                        <hr>
                                        <a href="{{ route('tipodoc') }}" class="btn btn-primary" role="button">Ir a la lista</a>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{ route('tipodoc.store') }}" method="post">
                                            @csrf
                                            ...
                                            <div class="form-outline mb-4">
                                                ...
                                                <input type="text" name="Codigo_doc" class="form-control"/>
                                            </div>
